...
const DropdownMenu: FC<INumber> = ({ id }) => {
...
const ProfileImage: FC<INumber> = ({ id }) => {
  const { photosList } = useSelector<IState, IUsersReducer>((globalState) => ({
    ...globalState.users,
  }));
  return <Photo src="https://images.pexels.com/photos/7907687/pexels-photo-7907687.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260" alt="profile" />;
};
